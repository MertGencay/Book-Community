  ...
  <section class="my-5">
    <div class="container">
      <SectionHeader
        ...
        text="Bir kitap, yalnızca bir hikâye değil; senin ruhuna dokunan bir yol arkadaşıdır."
      />
      <div class="row">
        <div class="col-md-4">
...
const carouselItems = [
  {
    ...
    title: 'Lev Tolstoy',
    description:
      'Kendini anlamaya başlayan insanın ilk dostu bir kitaptır. Çünkü kitap, bir insanın tüm iç çatışmalarını, hayallerini ve korkularını satırlara döken bir yoldaştır',
  },
  {
    imageUrl: hero_2,
    subtitle: '',
    title: 'İlber Ortaylı',
    description:
      'Kitap okumayan bir toplum, düşünce üretmez. Düşünce üretmeyen bir toplum, tarih yazmaz. Biz tarih okuyarak değil, onu yazarak yaşamak zorundayız ve bunun yolu okumaktan geçer.',
  },
  {
    imageUrl: hero_3,
    subtitle: '',
    title: 'Aziz Nesin',
    description:
      'Okumayan bir toplum, yönlendirilir. Okuyan ise sorgular, anlar ve yönünü kendi çizer. Kitaplar, başkasının değil, kendi aklınla yaşamanın anahtarıdır.',
  },
];

  ...
  <div class="container">
        ...
        <div class="d-flex flex-column h-100 justify-content-between">
          ...
          <div class="d-flex flex-column">
            <div class="row border-bottom pb-2">
              <div class="col-lg-6"><strong>Sayfa Sayısı</strong></div>
              <div class="col-lg-6">{{ book.pageNumber }}</div>
            </div>
            <div class="row border-bottom pb-2">
              <div class="col-lg-6"><strong>Puanı</strong></div>
              <div class="col-lg-6">
                {{ averageRating }} - ({{ ratingCount }} puanlayan)
              </div>
            </div>
            <div class="row border-bottom pb-2">
        ...
        <div class="box">
          <div v-if="isLoggedIn">
            <div v-if="!isUserAlreadyRated">
              <h3 style="color: var(--primary-color)">Kitabı Puanla</h3>
              <form @submit.prevent="addRate">
                ...
                <!-- Submit Button -->
                <button type="submit" class="btn btn-primary">Puan</button>
              </form>
            </div>

            <div v-else>Sizin oyunuz: {{ userRating }}</div>
          </div>
    ...
    <div class="row mt-3">
      <div class="col-md-12">
        <div class="box">
          <div v-if="isLoggedIn">
            <h3 style="color: var(--primary-color)">Kitabı Yorumla</h3>
            <form @submit.prevent="addComment">
              ...
              <!-- Submit Button -->
              <button type="submit" class="btn btn-primary">Yorum</button>
            </form>
          </div>
    ...
    <div class="row my-3">
      <div class="col-md-12">
        <div class="box">
          <h3 style="color: var(--primary-color)">Yorumlar</h3>
          <div>
            <div
              class="card mb-4"
                ...
                <div class="d-flex justify-content-between">
                  ...
                  >
                    <div
                      ...
                      v-if="!user"
                    >
                      <p class="small mb-0">Beğenmek için giriş yapmalısınız!</p>
                      <font-awesome-icon
                        :icon="['fas', 'thumbs-up']"
                    ...
                    >
                      <p class="small mb-0">
                        Kendi yorumunuzu beğenemezsiniz!
                      </p>
                      <font-awesome-icon
                        :icon="['fas', 'thumbs-up']"
                        style="color: var(--secondary-color)"
